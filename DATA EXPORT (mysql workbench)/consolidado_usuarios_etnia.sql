...
--
-- Host: localhost    Database: consolidado_usuarios
-- ------------------------------------------------------
...
INSERT INTO `etnia` VALUES (1,'6 Mestizo'),(2,'5 - Negro(a), Mulato(a), Afrocolombiano(a) o Afro descendiente'),(3,'1 - Indigena'),(4,'SIN INFORMACION'),(5,'3 - Raizal (archipiélago de San Andrés y Providencia)');
...
-- Dump completed on 2026-02-13 12:57:30
